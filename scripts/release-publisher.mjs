...
import { recoverHistoricalBeta2 } from "./release-publisher-beta2-recovery-run.mjs";
...
export async function runPublisher(root = process.cwd()) {
  ...
  const recovery = await recoverHistoricalBeta2(root, event, repository, payload.repository?.id, sha);
